	...
	public class CM_RandomEyes2D_Functions : MonoBehaviour 
	{
		...
		void OnGUI()
		{
			...
			if (!random) 
			{
				...
				{
					randomEyes2D.Look (RandomEyesLook.Position.UpRight);
				}
				
				yPos += (yGap + yHeight);
				if (GUI.Button (new Rect (xPos, yPos, xWidth, yHeight), "Look Up")) 
				{
					randomEyes2D.Look (RandomEyesLook.Position.Up);
				}
				
				yPos += (yGap + yHeight);
				if (GUI.Button (new Rect (xPos, yPos, xWidth, yHeight), "Look Up Left")) 
				{
					randomEyes2D.Look (RandomEyesLook.Position.UpLeft);
				}
				
				yPos += (yGap + yHeight);
				if (GUI.Button (new Rect (xPos, yPos, xWidth, yHeight), "Look Right")) 
				{
					randomEyes2D.Look (RandomEyesLook.Position.Right);
				}
				...
				{
					randomEyes2D.Look (RandomEyesLook.Position.Left);
				}
				
				yPos += (yGap + yHeight);
				if (GUI.Button (new Rect (xPos, yPos, xWidth, yHeight), "Look Down Right")) 
				{
					randomEyes2D.Look (RandomEyesLook.Position.DownRight);
				}
				
				yPos += (yGap + yHeight);
				if (GUI.Button (new Rect (xPos, yPos, xWidth, yHeight), "Look Down")) 
				{
					randomEyes2D.Look (RandomEyesLook.Position.Down);
				}
				
				yPos += (yGap + yHeight);
				if (GUI.Button (new Rect (xPos, yPos, xWidth, yHeight), "Look Down Left")) 
				{
					randomEyes2D.Look (RandomEyesLook.Position.DownLeft);
				}
				#endregion
			}
			#endregion
